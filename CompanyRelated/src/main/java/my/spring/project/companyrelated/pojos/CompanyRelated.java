package my.spring.project.companyrelated.pojos;
...
import my.spring.project.companyrelated.Ipo;
...
public class CompanyRelated {
	...
	public String toString() {
		return "CompanyRelated [ companyName=" + companyName + ", turnOver=" + turnOver + ", ceo=" + ceo
